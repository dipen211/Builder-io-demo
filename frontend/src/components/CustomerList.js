...
const CustomerList = () => {
      ...
      const mockCustomers = [
        {
          ...
          invoices: [{ id: 1, total: 1250.0, status: "Paid" }],
        },
        {
          id: 2,
          name: "Jane Smith",
          ...
          invoices: [{ id: 2, total: 890.0, status: "Sent" }],
        },
        {
          id: 3,
          name: "Acme Corp",
          ...
          invoices: [{ id: 3, total: 2350.0, status: "Draft" }],
        },
        {
          id: 4,
          name: "XYZ Company",
          ...
          invoices: [{ id: 4, total: 500.0, status: "Overdue" }],
        },
      ];
  ...
  const handleAddCustomer = async (e) => {
    e.preventDefault();
    try {
      // Mock adding customer - replace with: await ApiService.createCustomer(newCustomer);
  ...
  const calculateCustomerTotal = (invoices) => {
